...
_WEIGHTS_DIR = "/home/bahaudeen/vta-offline-mot-evaluation/tracker_frameworks/SUSHI/fastreid-models"
...
def _get_cfg(fastreid_cfg_file, fastreid_model_weights):
    ...
    print(_WEIGHTS_DIR)    
    print("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")    
    args = default_argument_parser().parse_args(['--config-file', osp.join('/home/bahaudeen/vta-offline-mot-evaluation/tracker_frameworks/SUSHI/fast-reid', fastreid_cfg_file), '--num-gpus', '1', 'MODEL.WEIGHTS', osp.join(_WEIGHTS_DIR, fastreid_model_weights)])
    #cfg = setup(args)
    cfg = get_cfg()
