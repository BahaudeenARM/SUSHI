...
def get_arguments(args=None):
    ...
    parser.add_argument('--data_path', help='Where is data located?', type=str,
                        default='/home/bahaudeen/vta-offline-mot-evaluation/tracker_frameworks/SUSHI/DATA_PATH')
    parser.add_argument('--output_path', help='Where is the output folder?', type=str,
                        default='/home/bahaudeen/vta-offline-mot-evaluation/tracker_frameworks/SUSHI/output')
